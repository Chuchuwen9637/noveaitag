<template>
    <div>
        ...
        <!--显示从父组件传过来的数据-->
        <div>
          <el-button type="success" style="float: right;" @click="handleCurrentChange()">全局搜索</el-button> <el-input v-model="vo.name" placeholder="请输入内容" ></el-input>
      </div>
